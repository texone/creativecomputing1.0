...
public class CCMosaicTriangleMesh{
	...
	private void subdevide(double x1, double y1, double x2, double y2, double x3, double y3, int level, int[][][] theTexCoords) {
		...
		double myRand0 = 0.5 + CCMath.random(-0.3,0.3);
		double myRand1 = 0.5 + CCMath.random(-0.3,0.3);
		double myRand2 = 0.5 + CCMath.random(-0.3,0.3);
		double x12 = x1 + (x2 - x1) * myRand0;
		double y12 = y1 + (y2 - y1) * myRand0;
		
		double x23 = x2 + (x3 - x2) * myRand1;
		double y23 = y2 + (y3 - y2) * myRand1;
		
		double x31 = x3 + (x1 - x3) * myRand2;
		double y31 = y3 + (y1 - y3) * myRand2;
