 ...
 */
package cc.creativecomputing.demo.input.touch;
...
public class CCTouchDemo extends CCApp {
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCTouchDemo.class);
