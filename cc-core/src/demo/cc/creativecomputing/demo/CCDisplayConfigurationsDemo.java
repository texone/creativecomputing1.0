...
public class CCDisplayConfigurationsDemo extends CCApp {
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCDisplayConfigurationsDemo.class);
		for(String myName:myManager.deviceNames()){
			CCLog.info(myName);
		}
		for(String myName:myManager.configurationNames()){
			CCLog.info(myName);
		}
