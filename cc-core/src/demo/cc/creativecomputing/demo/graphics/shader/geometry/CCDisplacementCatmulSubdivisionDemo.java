...
public class CCDisplacementCatmulSubdivisionDemo extends CCApp {
	...
	private static class CCLinesShader{
		...
		public CCLinesShader(CCGraphics g) {
			_myShader = new CCGLSLShader(
				"demo/gpu/geometry/catmul/vertex.glsl", 
				"demo/gpu/geometry/catmul/geometry.glsl", 
				"demo/gpu/geometry/catmul/fragment.glsl"
			);
...
//					g.color(1f);
		 ...
		 */
		public void start() {
			_myGraphics.texture(1,_myFilterTexture.attachment(0));
			_myShader.start();
	...
	private CCLinesShader _myLinesShader;
	
	@CCControl(name="displacement", min = 0, max = 500)
	...
	public void setup(){
		_myTexture = new CCTexture2D(CCTextureIO.newTextureData("demo/gpu/geometry/catmul/heightmap.png"));
		addControls("line controls", "line controls",this);
	
		_myLinesShader = new CCLinesShader(g);
		createMesh();	
	}
	...
	private void createMesh(){
		int _myYResolution = 200;
		int _myXResolution = 30;
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCDisplacementCatmulSubdivisionDemo.class);
