...
public class CCGPUWorleyNoise2x2 extends CCApp {
	...
	public void setup() {
		_myWorleyShader = new CCGLSLShader(
			...
			new String[] {
				...
				CCIOUtil.classPath(this, "cellular2x2_fragment.glsl")
			}
		);
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCGPUWorleyNoise2x2.class);
