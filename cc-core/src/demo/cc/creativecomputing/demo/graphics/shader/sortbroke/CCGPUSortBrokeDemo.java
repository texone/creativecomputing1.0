 ...
 */
package cc.creativecomputing.demo.graphics.shader.sortbroke;
...
public class CCGPUSortBrokeDemo extends CCApp {
	...
	public void setup() {
		...
		_myTexture = new CCTexture2D(CCTextureIO.newTextureData("demo/textures/lena.png"), CCTextureTarget.TEXTURE_RECT);
...
//					System.out.println(x+":" +y);
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCGPUSortBrokeDemo.class);
