...
public class CCMatrix3d {
	 ...
	 * @param theMatrix
	 */
	public CCMatrix3d(final CCMatrix3d theMatrix) {
		set(theMatrix);
	}
	 ...
	 */
	public CCMatrix3d clone() {
		CCMatrix3d outgoing = new CCMatrix3d();
		outgoing.set(this);
		return outgoing;
	}
	 ...
	 */
	public void set(final CCMatrix3d theMatrix) {
	 ...
	 * @param source
	 */
	public void apply(CCMatrix3d source) {
	 ...
	 */
	public void preApply(CCMatrix3d left) {
	 ...
	 */
	public CCVector2d mult(final CCVector2d theSource, CCVector2d theTarget) {
		if (theTarget == null) {
			theTarget = new CCVector2d();
		}
	 ...
	 * @return the result of the multiplication
	 */
	public CCVector2d mult(CCVector2d theSource) {
		return mult(theSource, null);
	}
	...
	public void print() {
		...
		System.out.println(CCFormatUtil.nds(m00, digits, 4) + " " + CCFormatUtil.nds(m01, digits, 4) + " " + CCFormatUtil.nds(m02, digits, 4));
		System.out.println(CCFormatUtil.nds(m10, digits, 4) + " " + CCFormatUtil.nds(m11, digits, 4) + " " + CCFormatUtil.nds(m12, digits, 4));
		System.out.println();
	}
