 ...
 * @author christianr
 */
public class CCGStreamerCapture extends CCVideoData implements CCDisposeListener{
...
//	private static
	...
	/**
	 * @param theApp typically use "this"
	 * @param theRequestWidth width of the frame
	 * @param theRequestHeight height of the frame
	 */
	public CCGStreamerCapture(CCApp theApp, int theRequestWidth, int theRequestHeight) {
		super(theApp);
		initGStreamer(theApp, theRequestWidth, theRequestHeight, CAPTURE_PLUGIN, null, "");
	}
	 ...
	 */
	public CCGStreamerCapture(CCApp theApp, int theRequestWidth, int theRequestHeight, int theFrameRate) {
		super(theApp);
		initGStreamer(theApp, theRequestWidth, theRequestHeight, CAPTURE_PLUGIN, null, theFrameRate + "/1");
	}
	 ...
	 */
	public CCGStreamerCapture(CCApp theApp, int theRequestWidth, int theRequestHeight, String theCameraName) {
		super(theApp);
		...
		initGStreamer(theApp, theRequestWidth, theRequestHeight, CAPTURE_PLUGIN, properties, "");
	}
	 ...
	 * the resolution.
	 */
	public CCGStreamerCapture(CCApp theApp, int theRequestWidth, int theRequestHeight, String theCameraName, int theFrameRate) {
		super(theApp);
		HashMap<String, Object> properties = new HashMap<String, Object>();
		if (DEVICE_PROPERTY_NAME.equals("")) {
			// For plugins without device name property, the name is casted as an index
		...
		initGStreamer(theApp, theRequestWidth, theRequestHeight, CAPTURE_PLUGIN, properties, theFrameRate + "/1");
	}
	...
	public CCGStreamerCapture(
		...
		super(theApp);
		initGStreamer(theApp, theRequestWidth, theRequestHeight, sourceName, properties, theFrameRate);
	}
...
//		}
	...
	private void initPipeline() {
		...
		pixelFormat(CCPixelFormat.BGRA);
