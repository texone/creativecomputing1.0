...
import cc.creativecomputing.CCSystem.CCEndianess;
 ...
 * @see CCApp 
 */
public class CCGraphics extends CCAbstractGraphics<GL2>{
	...
	public void resize(final int theWidth, final int theHeight){ // ignore
		super.resize(theWidth, theHeight);
	...
	public void reshape(int theX, int theY, int theWidth, int theHeight) {
		camera().viewport(new CCViewport(theX, theY, theWidth, theHeight));
	}
...
// blend mode keyword definitions
	...
	public void bezierVertex(
		final CCVector2f v1, final CCVector2f v2, final CCVector2f v3, final CCVector2f v4
	){
		bezierVertex(
			v1.x, v1.y, 
			v2.x, v2.y, 
	...
	public void bezierVertex(
		final CCVector2f v1, final CCVector2f v2, final CCVector2f v3
	){
		bezierVertex(
			v1.x, v1.y, 
			v2.x, v2.y, 
	 ...
	 */
	public void line(final CCVector2f v1, final CCVector2f v2) {
		beginShape(CCDrawMode.LINES);
		vertex(v1);
		vertex(v2);
		endShape();
	 ...
	 * @param v2 vector with the x,y coordinates of the lines end point
	 */
	public void line(final CCVector2d v1, final CCVector2d v2) {
		beginShape(CCDrawMode.LINES);
		vertex(v1);
		vertex(v2);
		endShape();
	...
	/**
	 * @param v1 CCVector3f: vector with the x,y,z coordinates of the lines start point
	 * @param v2 CCVector3f: vector with the x,y,z coordinates of the lines end point
	 */
	public void line(final CCVector3f v1, final CCVector3f v2) {
		beginShape(CCDrawMode.LINES);
		vertex(v1);
		vertex(v2);
		endShape();
	...
	/**
	 * @param v1 CCVector3d: vector with the x,y,z coordinates of the lines start point
	 * @param v2 CCVector3d: vector with the x,y,z coordinates of the lines end point
	 */
	public void line(final CCVector3d v1, final CCVector3d v2) {
		beginShape(CCDrawMode.LINES);
		vertex(v1);
		vertex(v2);
		endShape();
	 ...
	 * @related pointSize( )
	 */
	public void point(final float theX, final float theY){
	...
	/**
	 * @param theVector CCVector2f: vector with the x and y coord of the point to  draw
	 */
	public void point(final CCVector2f theVector){
		beginShape(CCDrawMode.POINTS);
		vertex(theVector);
		endShape();
	}
	 ...
	 */
	public void point(final float theX, final float theY, final float theZ){
		beginShape(CCDrawMode.POINTS);
	...
	/**
	 * @param theVector CCVector3f: vector containing the x,y and z coordinates of the point to draw
	 */
	public void point(final CCVector3f theVector){
		beginShape(CCDrawMode.POINTS);
		vertex(theVector);
		endShape();
	}
	 ...
	 * @param theVector CCVector3f: vector containing the x,y and z coordinates of the point to draw
	 */
	public void point(final CCVector3d theVector){
		beginShape(CCDrawMode.POINTS);
		vertex(theVector);
		endShape();
	}
	 ...
	 * @return float: the current pointSize
	 */
	 ...
	 * @return
	 */
	public float pointSizeMaximum(){
		return getFloat(GL2.GL_POINT_SIZE_MAX);
	}

	public void pointSizeMaximum(final float thePointSize){
		gl.glPointParameterf(GL2.GL_POINT_SIZE_MAX, thePointSize);
	}
	 ...
	 * @return
	 */
	public float pointSizeMinimum(){
		return getFloat(GL2.GL_POINT_SIZE_MIN);
	}

	public void pointSizeMinimum(final float thePointSize){
		gl.glPointParameterf(GL2.GL_POINT_SIZE_MIN, thePointSize);
	}
	...
	public void pointDistanceAttenuation(final float theConstant, final float theLinear, final float theQuadratic){
		float quadratic[] =  { theConstant, theLinear, theQuadratic };
	...
	public void triangle(
		final float theX1, final float theY1, final float theZ1,
		final float theX2, final float theY2, final float theZ2,
		final float theX3, final float theY3, final float theZ3
	){
	 ...
	 */
	public void triangle(final CCVector3f thePoint1, final CCVector3f thePoint2, final CCVector3f thePoint3){
		beginShape(CCDrawMode.TRIANGLES);
		vertex(thePoint1);
		vertex(thePoint2);
		vertex(thePoint3);
	 ...
	 * @param thePoint3 third point
	 */
	public void triangle(final CCVector3d thePoint1, final CCVector3d thePoint2, final CCVector3d thePoint3){
		beginShape(CCDrawMode.TRIANGLES);
		vertex(thePoint1);
		vertex(thePoint2);
		vertex(thePoint3);
	...
	public void triangle(
		final float theX1, final float theY1,
		final float theX2, final float theY2,
		final float theX3, final float theY3
	){
		beginShape(CCDrawMode.TRIANGLES);
		vertex(theX1, theY1);
		vertex(theX2, theY2);
	 ...
	 * @param thePoint3 third point
	 */
	public void triangle(final CCVector2f thePoint1, final CCVector2f thePoint2, final CCVector2f thePoint3){
		beginShape(CCDrawMode.TRIANGLES);
		vertex(thePoint1);
		vertex(thePoint2);
		vertex(thePoint3);
	 ...
	 * @param thePoint3 third point
	 */
	public void triangle(final CCVector2d thePoint1, final CCVector2d thePoint2, final CCVector2d thePoint3){
		beginShape(CCDrawMode.TRIANGLES);
		vertex(thePoint1);
		vertex(thePoint2);
		vertex(thePoint3);
	...
	public void rect(final CCVector2f thePosition, final CCVector2f theDimension){
	...
	static final private float sinLUT[];
	static final private float cosLUT[];
	static final private float SINCOS_PRECISION = 0.5f;
	...
	public void ellipse(final float theX, float theY, final float theZ, final float theWidth, final float theHeight, boolean theDrawOutline) {
	    float x = theX;
	    float y = theY;
	    float w = theWidth;
	    float h = theHeight;
	    ...
	    float centerX = x + hradius;
	    float centerY = y + vradius;
	 ...
	 * @param theHeight
	 */
	public void ellipse(final float theX, float theY, final float theZ, final float theWidth, final float theHeight) {
	    ellipse(theX, theY, theZ, theWidth, theHeight, false);
	}
	
	public void ellipse(final double theX, final double theY, final double theZ, final double theWidth, final double theHeight){
		ellipse((float)theX, (float)theY, (float)theZ, (float)theWidth, (float)theHeight);
	}
	
	public void ellipse(final float theX, final float theY, final float theWidth, final float theHeight){
	...
	public void ellipse(final double theX, final double theY, final double theWidth, final double theHeight){
		ellipse((float)theX, (float)theY, 0, (float)theWidth, (float)theHeight);
	}
	
	public void ellipse(final float theX, final float theY, final float theDiameter){
		ellipse(theX,theY,0,theDiameter,theDiameter);
	}
	
	public void ellipse(final CCVector2f thePosition, final float theDiameter){
		ellipse(thePosition.x, thePosition.y, theDiameter, theDiameter);
	}
	
	public void ellipse(final CCVector2d thePosition, final float theDiameter){
		ellipse(thePosition.x, thePosition.y, theDiameter, theDiameter);
	}
	
	public void ellipse(final CCVector2f thePosition, final float theWidth, final float theHeight){
		ellipse(thePosition.x, thePosition.y, theWidth, theHeight);
	}
	
	public void ellipse(final CCVector3f thePosition, final float theDiameter){
	...
	public void arc(
		...
		final float theStart, float theStop
	) {
		float x = theX;
		float y = theY;
		float w = theWidth;
		...
		if (Float.isInfinite(theStart) || Float.isInfinite(theStop)){
			return;
		}
	...
	public void box(final CCVector3f theDimension){
		box(theDimension.x, theDimension.y, theDimension.z);
	}

	public void box(float theXSize, float theYSize, float theZSize){
		final float x1 = -theXSize / 2f;
		final float x2 = theXSize / 2f;
		final float y1 = -theYSize / 2f;
		final float y2 = theYSize / 2f;
		final float z1 = -theZSize / 2f;
		final float z2 = theZSize / 2f;
	...
	public void boxGrid(final float size){
		boxGrid(size, size, size);
	}
	
	public void boxGrid(float theXSize, float theYSize, float theZSize){
		final float x1 = -theXSize / 2f;
		final float x2 = theXSize / 2f;
		final float y1 = -theYSize / 2f;
		final float y2 = theYSize / 2f;
	 ...
	 * @param radius
	 */
	public void sphere(final float radius){
	...
	public void applyTextureTransformation(final int theTextureUnit, final CCTexture theTexture) {
		...
		float myTextureXscale = 1;
		float myTextureYscale = 1;
	 ...
	 */
	public void texGen(final CCTextureGenMode theMode, float...theData) {
...
//		texGen(CCTextureGenCoord.Q, theMode);
	 ...
	 * @param theMode the texture coord generation mode to apply
	 */
	public void texGen(final CCTextureGenCoord theCoord, final CCTextureGenMode theMode, float...theData) {
		...
		gl.glTexGenfv(theCoord.glID, theMode.glPlaneId, theData,0);
	}
	...
	public void textureCoords(float theX){
		gl.glTexCoord1f(theX);
	}
	
	public void textureCoords(final CCVector2f theTextureCoords){
		gl.glTexCoord2f(theTextureCoords.x, theTextureCoords.y);
	}
	
	public void textureCoords(final CCVector2d theTextureCoords){
		gl.glTexCoord2d(theTextureCoords.x, theTextureCoords.y);
	}
	
	public void textureCoords(float theX, float theY){
		gl.glTexCoord2f(theX, theY);
	}
	...
	public void textureCoords(final CCVector3f theTextureCoords){
		gl.glTexCoord3f(theTextureCoords.x, theTextureCoords.y, theTextureCoords.z);
	}
	
	public void textureCoords(float theX, float theY, float theZ){
		gl.glTexCoord3f(theX, theY, theZ);
	}
	
	public void textureCoords(final int theTextureUnit, final float theX) {
		gl.glMultiTexCoord1f(theTextureUnit, theX);
	}
	
	public void textureCoords(final int theTextureUnit, final CCVector2f theTextureCoords){
		gl.glMultiTexCoord2f(theTextureUnit,theTextureCoords.x, theTextureCoords.y);
	}
	
	public void textureCoords(final int theTextureUnit, final CCVector2d theTextureCoords){
		gl.glMultiTexCoord2d(theTextureUnit,theTextureCoords.x, theTextureCoords.y);
	}
	
	public void textureCoords(final int theTextureUnit, float theX, float theY){
		gl.glMultiTexCoord2f(theTextureUnit, theX, theY);
	}
	
	public void textureCoords(final int theUnit, CCVector3f theVector){
		gl.glMultiTexCoord3f(theUnit, theVector.x, theVector.y, theVector.z);
	}
	
	public void textureCoords(final int theUnit, final float theX, final float theY, final float theZ){
		gl.glMultiTexCoord3f(theUnit, theX, theY, theZ);
	}
	
	public void textureCoords(final int theUnit, CCVector4f theVector){
		gl.glMultiTexCoord4f(theUnit, theVector.x, theVector.y, theVector.z, theVector.w);
	}
	
	public void textureCoords(final int theUnit, final float theX, final float theY, final float theZ, final float theW){
		gl.glMultiTexCoord4f(theUnit, theX, theY, theZ, theW);
	}
...
//			}
	 ...
	 */
	public void image(final CCTexture theImage, final float theX, final float theY) {
		image(theImage, theX, theY, theImage.width(), theImage.height());
	}
	
	public void image(final CCTexture theImage, final CCVector2f theVector){
	...
	public void image(final CCTexture theImage, final CCVector2f thePosition, final CCVector2f theDimension){
		image(theImage, thePosition.x,thePosition.y,theDimension.x,theDimension.y);
	}
	
	public void image(
		final CCTexture theImage, 
		final float theX1, final float theY1, final float theX2, final float theY2,
		final float theIX1, final float theIY1, final float theIX2, final float theIY2
	){
		CCTextureMode myStoredTextureMode = _myTextureMode;
		_myTextureMode = CCTextureMode.IMAGE;
		imageImplementation(
	...
	public void camera(final CCVector3f thePosition, final CCVector3f theTarget, final CCVector3f theUp){
	...
	public void camera(
		final float thePositionX, final float thePositionY, float thePositionZ,
	...
	public void cameraPosition(final float thePositionX, final float thePositionY, float thePositionZ){
		_myCamera.position(thePositionX, thePositionY, thePositionZ);
		_myCamera.draw(this);
	}
	
	public void cameraPosition(final CCVector3f thePosition){
		cameraPosition(thePosition.x, thePosition.y, thePosition.z);
	}
	
	public void cameraTarget(final float theCenterX, final float theCenterY, final float theCenterZ){
		_myCamera.target(theCenterX, theCenterY, theCenterZ);
		_myCamera.draw(this);
	}
	
	public void cameraTarget(final CCVector3f theCenter){
	 ...
	 */
	public void ortho(
		final float theLeft, final float theRight, 
		final float theBottom, final float theTop, 
		final float theNear, final float theFar
	){
	...
	public CCClipSpaceFrustum frustum(){
		return _myFrustum;
	}
	...
	public void material(final CCMaterial theMaterial){
		theMaterial.draw(this);
	}
	 ...
	 */
	public void lightModelAmbient(final float theRed, final float theGreen, final float theBlue){
	...
	public void lightModelAmbient(final CCColor theColor){
		gl.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT, theColor.array(), 0);
	}
	 ...
	 * @see #light(CCLight)
	 * @see #lightModelColorControl(boolean)
	 * @see #lightModelAmbient(float, float, float)
	 * @see #lightModelTwoSide(boolean)
	 */
	 ...
	 */
	public void textFont(final CCFont<?> theFont, final float theSize) {
	 ...
	 * calls to textSize().
	 */
	public void textLeading(final float theTextLeading) {
	 ...
	 */
	public void textSize(final float theSize){
	...
	public void text(final char theChar, final float theX, final float theY){
		text(theChar,theX,theY);
	}

	public void text(final char theChar, final float theX, final float theY, final float theZ){
		_myText.text(theChar);
		_myText.position(theX, theY, theZ);
		_myText.draw(this);
	}

	public void text(final String theString, final float theX, float theY, final float theZ){
		_myText.text(theString);
		_myText.position(theX, theY, theZ);
		_myText.draw(this);
	}
	
	public void text(String theText, final double theX, final double theY, final double theZ) {
		text(theText, (float)theX, (float)theY, (float)theZ);
	}
	
	public void text(String theText, CCVector3f theVector) {
		text(theText, theVector.x, theVector.y, theVector.z);
	}
	
	public void text(String theText, CCVector3d theVector) {
		text(theText, (float)theVector.x, (float)theVector.y, (float)theVector.z);
	}

	public void text(final String theString, final float theX, final float theY){
	...
	public void text(final String theString, final CCVector2f theVector){
		text(theString, theVector.x, theVector.y);
	}
	
	public void text(final String theString, final CCVector2d theVector){
		text(theString, theVector.x, theVector.y);
	}

	public void text(final int theNumber, final float theX, final float theY){
		text(String.valueOf(theNumber), theX, theY);
	}

	public void text(final int theNumber, final CCVector2f theVector){
		text(String.valueOf(theNumber), theVector.x, theVector.y);
	}

	public void text(final int theNumber, final CCVector2d theVector){
		text(String.valueOf(theNumber), (float)theVector.x, (float)theVector.y);
	}

	public void text(final int theNumber, final float theX, final float theY, final float theZ){
		text(String.valueOf(theNumber), theX, theY, theZ);
	}

	public void text(final int theNumber, final CCVector3f theVector){
	 ...
	 */
	public void text(final float theNumber, final float theX, final float theY){
		text(CCFormatUtil.nfs(theNumber, 0, 3), theX, theY);
	}

	public void text(final float theNumber, final float theX, final float theY, final float theZ){
		text(CCFormatUtil.nfs(theNumber, 0, 3), theX, theY, theZ);
	}
	...
	public void rasterPos(final float theX, final float theY) {
		gl.glRasterPos2f(theX, theY);
	}
	...
	public void windowPos(final float theX, final float theY) {
		gl.glWindowPos2f(theX, theY);
	}
	...
	public void copy(
		...
		float u1 = (float)sx1/src.width();
		float u2 = (float)sx2/src.width();
		float v1 = (float)sy1/src.height();
		float v2 = (float)sy2/src.height();
