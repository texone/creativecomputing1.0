...
public class CCCGShader extends CCShader{
	...
	public CCCGShader(
		...
		final String theFragmentEntry, final String theMatrixParameter
	) {
	...
	public CCCGShader(
		...
		this(new String[] {theVertexShaderFile}, theVertexEntry, new String[] {theFragmentShaderFile}, theFragmentEntry, theMatrixParameter);
	}
	...
	private CGprogram loadShader(final String theEntry, final int theProfile,final String...theFiles){
	...
	public void parameter(final CGparameter theParameter, final float theValue){
		CgGL.cgSetParameter1f(theParameter, theValue);
		checkError("Problem setting parameters ");
	}
	
	public void parameter(final CGparameter theParameter, final float theV1, final float theV2){
		CgGL.cgSetParameter2f(theParameter, theV1, theV2);
		checkError("Problem setting parameters ");
	}
	
	public void parameter(final CGparameter theParameter, final float theV1, final float theV2, final float theV3){
		CgGL.cgSetParameter3f(theParameter, theV1, theV2, theV3);
		checkError("Problem setting parameters ");
	}
	
	public void parameter(final CGparameter theParameter, final float theV1, final float theV2, final float theV3, final float theV4){
		CgGL.cgSetParameter4f(theParameter, theV1, theV2, theV3, theV4);
		checkError("Problem setting parameters ");
	}
	
	public void parameter(final CGparameter theParameter, final CCVector3f theVector){
		CgGL.cgSetParameter3f(theParameter, theVector.x, theVector.y, theVector.z);
		checkError("Problem setting parameters ");
	}
	...
	public void parameter(final CGparameter theParameter, final CCVector2f theVector){
		CgGL.cgSetParameter2f(theParameter, theVector.x, theVector.y);
		checkError("Problem setting parameters ");
	}
	
	public void parameter(final CGparameter theParameter, final CCColor theColor){
		CgGL.cgSetParameter4f(theParameter, theColor.r, theColor.g, theColor.b, theColor.a);
		checkError("Problem setting parameters ");
	}
	
	public void parameter1(final CGparameter theParameter, final List<Float> theParameterValues) {
		FloatBuffer myValueBuffer = FloatBuffer.allocate(theParameterValues.size());
		for(Float myValue:theParameterValues) {
			myValueBuffer.put(myValue);
		}
		myValueBuffer.flip();
		
		CgGL.cgGLSetParameterArray1f(theParameter, 0, theParameterValues.size(), myValueBuffer);
	}
	
	public void parameter1(final CGparameter theParameter, final float...theParameterValues) {
		FloatBuffer myValueBuffer = FloatBuffer.wrap(theParameterValues);
		myValueBuffer.flip();
		
		CgGL.cgGLSetParameterArray1f(theParameter, 0, theParameterValues.length, myValueBuffer);
	}
	
	public void parameter2(final CGparameter theParameter, final List<CCVector2f> theParameterValues) {
		FloatBuffer myValueBuffer = FloatBuffer.allocate(theParameterValues.size() * 2);
		for(CCVector2f myVector:theParameterValues) {
			myValueBuffer.put(myVector.x);
			myValueBuffer.put(myVector.y);
		}
		myValueBuffer.flip();
		
		CgGL.cgGLSetParameterArray2f(theParameter, 0, theParameterValues.size(), myValueBuffer);
	}
	
	public void parameter2(final CGparameter theParameter, final CCVector2f[] theParameterValues) {
		FloatBuffer myValueBuffer = FloatBuffer.allocate(theParameterValues.length * 2);
		for(CCVector2f myVector:theParameterValues) {
			myValueBuffer.put(myVector.x);
			myValueBuffer.put(myVector.y);
		}
		...
		CgGL.cgGLSetParameterArray2f(theParameter, 0, theParameterValues.length, myValueBuffer);
	}
	
	public void parameter3(final CGparameter theParameter, final List<CCVector3f> theParameterValues) {
		FloatBuffer myValueBuffer = FloatBuffer.allocate(theParameterValues.size() * 3);
		for(CCVector3f myVector:theParameterValues) {
			myValueBuffer.put(myVector.x);
			myValueBuffer.put(myVector.y);
		...
		CgGL.cgGLSetParameterArray3f(theParameter, 0, theParameterValues.size(), myValueBuffer);
	}
	
	public void matrix(final CGparameter theParameter, final CCMatrix4f theMatrix) {
		CgGL.cgSetMatrixParameterfc(theParameter, theMatrix.toFloatBuffer());
	}
