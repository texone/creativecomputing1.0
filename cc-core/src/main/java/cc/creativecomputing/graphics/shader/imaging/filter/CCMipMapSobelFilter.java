...
public class CCMipMapSobelFilter extends CCImageFilter {
	...
	@CCControl(name = "lod", min = 1, max = 10, external=true)
	private int _cLod = 1;
	...
	public CCMipMapSobelFilter (CCGraphics theGraphics, CCTexture2D theInput) {
		...
		_myShader = new CCGLSLShader(CCIOUtil.classPath(this, "shader/sobel_mipmap_vp.glsl"), CCIOUtil.classPath(this, "shader/sobel_mipmap_fp.glsl"));
		_myShader.load();
	...
	public void update(float theDeltaTime) {
		...
		_myGraphics.textureCoords(0, 0f,0f);
		_myGraphics.vertex (0,0);
		_myGraphics.textureCoords(0, 1f,0f);
		_myGraphics.vertex (_myOutput.width(), 0);
		_myGraphics.textureCoords(0, 1f,1f);
		_myGraphics.vertex(_myOutput.width(), _myOutput.height());
		_myGraphics.textureCoords(0, 0f,1f);
