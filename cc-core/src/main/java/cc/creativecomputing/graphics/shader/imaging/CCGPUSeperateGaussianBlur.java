...
public class CCGPUSeperateGaussianBlur extends CCGPUConvolutionShader{
	 ...
	 */
	public CCGPUSeperateGaussianBlur(float theMaximumRadius, final int theWidth, final int theHeight, final int theRes) {
		super();
		_myRes = theRes;
	...
	public CCGPUSeperateGaussianBlur(float theMaximumRadius, final int theWidth, final int theHeight) {
     ...
     * @return the kernel
	 */
	private List<Float> calculateKernel(float theRadius){
