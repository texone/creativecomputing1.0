...
public class CCVectorField2D {
	...
	public CCVectorField2D (int w, int h, int initDownSample) {
		...
		_myShader = new CCGLSLShader (CCIOUtil.classPath(this, "shader/vectorField2Lines_vp.glsl"), CCIOUtil.classPath(this, "shader/vectorField2Lines_fp.glsl"));
		_myShader.load();
	}
