...
public class CCSurfaceFilter extends CCImageFilter{
	...
	@CCControl(name = "depth", min = -1, max = 1)
	...
	public CCSurfaceFilter (CCGraphics theGraphics, CCTexture2D theInput, CCTexture2D theInput2) {
		...
		_myShader = new CCGLSLShader (CCIOUtil.classPath(this, "shader/surface_vp.glsl"), CCIOUtil.classPath(this, "shader/surface_fp.glsl"));
		_myShader.load();	
