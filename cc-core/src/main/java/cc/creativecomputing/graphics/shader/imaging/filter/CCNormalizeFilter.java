...
public class CCNormalizeFilter extends CCImageFilter {
	...
	private CCGLSLShader   _myScalingShader;
	...
	public CCNormalizeFilter (CCGraphics theGraphics, CCTexture2D theInput) {
		...
		_myScalingShader = new CCGLSLShader (CCIOUtil.classPath(this, "shader/normalize_vertex.glsl"), CCIOUtil.classPath(this, "shader/normalize_fragment.glsl"));
		_myScalingShader.load();
