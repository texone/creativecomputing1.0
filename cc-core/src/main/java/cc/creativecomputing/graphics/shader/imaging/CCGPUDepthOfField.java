...
public class CCGPUDepthOfField {
	...
	public CCGPUDepthOfField(final CCGraphics g, final int theWidth, final int theHeight) {
		...
		_mySceneShader = new CCCGShader(
			CCIOUtil.classPath(this,"dof/scene.vp"), 
			CCIOUtil.classPath(this,"dof/scene.fp"));
		...
		_myDownSampleShader = new CCCGShader(
			CCIOUtil.classPath(this,"dof/downsample.vp"), 
			CCIOUtil.classPath(this,"dof/downsample.fp")
		);
		_myDownSampleShader.load();
		
		_myThirdShader = new CCGLSLShader(
			CCIOUtil.classPath(this,"dof/third.vert"), 
			CCIOUtil.classPath(this,"dof/third.frag")
		);
		_myThirdShader.load();
		_myFourthShader = new CCGLSLShader(
			CCIOUtil.classPath(this,"dof/fourth.vert"), 
			CCIOUtil.classPath(this,"dof/fourth.frag")
		);
		_myFourthShader.load();
		_myFifthShader = new CCGLSLShader(
			CCIOUtil.classPath(this,"dof/fifth.vert"), 
			CCIOUtil.classPath(this,"dof/fifth.frag")
		);
		_myFifthShader.load();
