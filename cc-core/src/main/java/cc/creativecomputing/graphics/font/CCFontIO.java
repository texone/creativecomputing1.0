...
public class CCFontIO{
	...
	static public CC3DFont create3DFont(final String theName, final float theSize, final CCCharSet theCharset, final float theDepth){
		CCFontSettings mySettings = new CCFontSettings(theName, theSize, true, theCharset);
		mySettings.detail(30);
	 ...
	 * @return
	 */
	static public CCOutlineFont createOutlineFont(final String theName, final float theSize, final CCCharSet theCharset, final int theDetail){
		CCFontSettings mySettings = new CCFontSettings(theName, theSize, true, theCharset);
