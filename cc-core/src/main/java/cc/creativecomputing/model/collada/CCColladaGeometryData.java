...
public abstract class CCColladaGeometryData extends CCColladaSubTag {
	...
	private class CCColladaGeometryInput{
	...
	private Map<String, CCColladaGeometryInput> _myInputMap = new HashMap<>();
	...
	CCColladaGeometryData(CCXMLElement theDataXML, HashMap<String, CCColladaSource> theSources, CCColladaVertices theVertices, int thePrimitivSize){
		...
		_myPointIndices = new int[_myNumberOfVertices * _myStride];
		...
		for(CCColladaGeometryInput myInput:myInputs){
