...
public class CCArrayUtil{
	...
	static public boolean[] expand(final boolean theBooleanArray[]){
		return resize(theBooleanArray, theBooleanArray.length << 1);
	}
	 ...
	 */
	static public boolean[] resize(final boolean[] theBooleanArray, int theNewSize){
	...
	static public byte[] expand(final byte theByteArray[]){
		return resize(theByteArray, theByteArray.length << 1);
	}

	static public byte[] resize(final byte theByteArray[], final int theNewSize){
	...
	static public char[] expand(final char theCharArray[]){
		return resize(theCharArray, theCharArray.length << 1);
	}
	
	static public char[] resize(final char theCharArray[], final int theNewSize){
	...
	static public int[] expand(int list[]){
		return resize(list, list.length << 1);
	}

	static public int[] resize(int list[], int newSize){
	...
	static public float[] resize(float list[], int newSize){
	...
	static public double[] resize(double list[], int newSize){
