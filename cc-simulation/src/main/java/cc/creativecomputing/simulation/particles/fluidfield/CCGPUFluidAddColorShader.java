 ...
 *
 */
public class CCGPUFluidAddColorShader extends CCCGShader{
	 ...
	 */
	public CCGPUFluidAddColorShader(CCGraphics theG) {
		super(null, CCIOUtil.classPath(CCGPUFluid.class,"shader/addcolor.fp"));
	...
	public void color(final CCColor theColor) {
		parameter(_myColorParameter, theColor.red(), theColor.green(), theColor.blue(), 1f);
	}
