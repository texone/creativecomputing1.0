 ...
 *
 */
public class CCGPUNearestGridPositionTargetForce extends CCGPUForce {
	...
	public void setSize(CCGraphics g, int theWidth, int theHeight) {
		...
		_myNearestTargetShader = new CCCGShader(null, CCIOUtil.classPath(CCGPUParticles.class,"shader/nearestTarget.fp"));
		...
		_myNearestTargetChangeShader = new CCCGShader(
			CCIOUtil.classPath(CCGPUParticles.class,"shader/nearestTargetChange.vp"),
			CCIOUtil.classPath(CCGPUParticles.class,"shader/nearestTargetChange.fp")
		);
