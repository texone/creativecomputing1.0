...
public class CCGPUIndexParticleCurveEmitter extends CCGPUIndexParticleEmitter{
	...
	public CCGPUIndexParticleCurveEmitter(CCGPUParticles theParticles, int theStart, int theNumberParticles) {
		super(theParticles, theStart, theNumberParticles);
		_myCurveEmitShader = new CCCGShader(
			null,
			new String[] {
				CCIOUtil.classPath(CCGPUParticles.class,"shader/simplex.fp"),
				CCIOUtil.classPath(CCGPUParticles.class, "shader/emit/curvefield_emit.fp")
			}
		);
