...
public class CCGPUPointCurveField extends CCGPUForce{
	...
	public CCGPUPointCurveField(int theNumberOfPoints, CCGraphics g){
		...
		_myInitValueShader = new CCCGShader(null, CCIOUtil.classPath(CCGPUParticles.class, "shader/initvalue.fp"));
