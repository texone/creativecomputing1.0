 ...
 *
 */
public class CCGPUTexture3DForceField extends CCGPUForce{
	...
	private float _myLookAheadStart;
	private float _myLookAheadEnd;
	...
	private CGparameter _myLookAheadStartParameter;
	private CGparameter _myLookAheadEndParameter;
	
	public CCGPUTexture3DForceField(
		final CCTexture3D theTexture,
		final CCVector3f theTextureScale,
		final CCVector3f theTextureOffset
	){
		super("Texture3DForceField");
	...
	public void setupParameter(int theWidth, int theHeight){
		...
		_myLookAheadStartParameter = parameter("lookStart");
		_myLookAheadEndParameter = parameter("lookEnd");
	...
	public void update(final float theDeltaTime) {
		...
		_myVelocityShader.parameter(_myLookAheadStartParameter, _myLookAheadStart);
		_myVelocityShader.parameter(_myLookAheadEndParameter, _myLookAheadEnd);
	}
	
	public void lookAheadStart(float theLookAheadStart){
		_myLookAheadStart = theLookAheadStart;
	}
	
	public void lookAheadEnd(float theLookAheadEnd){
		_myLookAheadEnd = theLookAheadEnd;
	}
