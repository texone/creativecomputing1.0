...
public class CCGPUParticlesDensity {
	...
	public CCGPUParticlesDensity (CCGPUParticles theParticles, CCGraphics theGraphics) {
		this(theParticles, theGraphics, CCDensitySpriteShape.DISTANCE, 1, theParticles.width(), theParticles.height());
	}
	
	public CCGPUParticlesDensity (CCGPUParticles theParticles, CCGraphics theGraphics, int width, int height) {
		this(theParticles, theGraphics, CCDensitySpriteShape.DISTANCE, 1, width, height);
	}
	
	public CCGPUParticlesDensity (CCGPUParticles theParticles, CCGraphics theGraphics, CCDensitySpriteShape theSpriteShape, int thePointSize, int width, int height) {
