 ...
 *
 */
public class CCMultipleColorDemo2 extends CCApp{
	...
	public void setup() {
		...
		myForces.add(_myAttractor = new CCGPUAttractor(new CCVector3f(), 0, 100));
		...
		_myParticles = new CCGPUParticles(g, myForces, myConstraints, 300, 300);
	...
	public void draw() {
		...
		g.image(_myColorTexture.attachment(0), -width/2,-height/2);
	}
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCMultipleColorDemo2.class);
