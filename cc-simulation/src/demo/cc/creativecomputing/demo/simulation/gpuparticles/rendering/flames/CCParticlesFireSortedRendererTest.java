...
public class CCParticlesFireSortedRendererTest extends CCApp {
	...
	public void setup() {
		...
		myForces.add(_myGravity = new CCGPUGravity(new CCVector3f(0,1,0)));
		...
		_myParticles = new CCGPUParticles(g, _myRenderer, myForces, new ArrayList<CCGPUConstraint>(), 128,128);
