...
public class CCGPUPointSpriteRendererDemo extends CCApp {
	...
	public void setup() {
		...
		myForces.add(_myGravity = new CCGPUGravity(new CCVector3f(2,0,0)));
		...
		_myParticles = new CCGPUParticles(g, _myRenderer, myForces, new ArrayList<CCGPUConstraint>(), 500,500);
