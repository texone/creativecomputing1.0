...
public class CCDynamicIndividualTargetsDemo extends CCApp {
	...
	private class SAKidsBackground{
		...
		public SAKidsBackground(){
			List<CCGPUForce> myCobinedForces = new ArrayList<CCGPUForce>();
			myCobinedForces.add(new CCGPUGravity(new CCVector3f()));
			myCobinedForces.add(_myForceField = new CCGPUForceField(0.01f, 1f, new CCVector3f()));
...
//			myForces.add(_myTimeBlendForce);
			...
			myForces.add(_myViscousDrag = new CCGPUViscousDrag(0.1f));
