...
public class CCParticlesTextureForceBlendTest extends CCApp {
	...
	public void setup() {
		...
		_myForceBlend1 = new CCGPUTextureForceBlend(myBlendTexture, new CCGPUGravity(new CCVector3f(0,0,0)), _myNoiseForceField);
		...
		_myParticles = new CCGPUParticles(g,myForces, new ArrayList<CCGPUConstraint>(),300,300);
