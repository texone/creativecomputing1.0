...
//		g.camera().far(1000);
		...
		List<CCGPUForce> myCombindedForces = new ArrayList<CCGPUForce>();
		myCombindedForces.add(_myGravity = new CCGPUGravity(new CCVector3f()));
		myCombindedForces.add(_myForceField = new CCGPUForceField(0.01f, 1f, new CCVector3f()));
		CCGPUCombinedForce myCombinedForce = new CCGPUCombinedForce(myCombindedForces);
		
		_myTimeBlendForce = new CCGPUTimeForceBlend(0,10, new CCGPUGravity(new CCVector3f()) , myCombinedForce);
...
//		_myTimeBlendForce.power(6);
		...
		_myParticles = new CCGPUParticles(g, new CCGPUIndexedParticleRenderer(), myForces, myConstraints, 800, 800);
