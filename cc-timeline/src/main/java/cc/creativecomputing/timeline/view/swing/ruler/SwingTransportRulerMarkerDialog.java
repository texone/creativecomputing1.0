...
class SwingTransportRulerMarkerDialog extends JDialog implements ActionListener, PropertyChangeListener {
		/**
	 * 
	 */
	private static final long serialVersionUID = 139787124989150690L;
		...
		private SwingTransportRulerView _myRulerView;

		/** Creates the reusable dialog. */
		public SwingTransportRulerMarkerDialog(SwingTransportRulerView theRulerView, String aWord) {
			super();
