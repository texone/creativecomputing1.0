 ...
 * 
 */
public class CCOpenNISDFDemo extends CCApp {
	...
	public void setup() {
		...
		_mySignedDistanceField = new CCOpenNISignedDistanceField(this, _myDepthGenerator.texture(), 64, 48, 16);
		addControls("app", "app", _mySignedDistanceField);
...
//		g.perspective(95, width / (float) height, 10, 150000);
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCOpenNISDFDemo.class);
